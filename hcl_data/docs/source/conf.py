...
# hcl_model_project documentation build
...
from hcl_model_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "hcl_model_project"
author = "Kedro"
...
htmlhelp_basename = "hcl_model_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "hcl_model_project.tex",
        "hcl_model_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "hcl_model_project",
        "Project hcl_model_project codebase.",
        "Data-Science",
    )
]
